...
React functional component
    ...
    > is a JavaScript function that returns JSX, describing what should be rendered to the DOM. It's typically used for simpler components without lifecycle methods or state management.
